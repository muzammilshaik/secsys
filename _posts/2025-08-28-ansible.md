...
![Ansible](/assets/dev/ansible/ansible_architecture.svg){: width="800" height="500" }

### Detailed Architecture Components

![Ansible](/assets/dev/ansible/architecture_components.svg){: width="800" height="500" }

### Ansible Execution Flow

![Ansible](/assets/dev/ansible/ansible_execution_flow.svg){: width="800" height="500" }
...
![Ansible](/assets/dev/ansible/variables.svg){: width="800" height="500" }
