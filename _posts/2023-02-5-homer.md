...
You can add custom CSS to homer in order to have a personal look similar to the one I have used from Walkxcode called [homer-theme](https://github.com/walkxcode/homer-theme)

![dashboard](/assets/docker/homer/dashboard.png){: width="800" height="500" }

> For More details please check the [manual](https://homer-demo.netlify.app/)
{: .prompt-info}