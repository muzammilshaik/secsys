---
author: muju
title: "Installing Talos OS with Kubernetes on Proxmox"
...
Download the latest Talos OS ISO image from the official GitHub releases page:
...
Talos comes with flannel CNI by default, but you can install other CNI plugins if desired. For example, to install Cilium:
...
- [Official Talos OS Website](https://www.talos.dev)
- [Talos OS Documentation](https://www.talos.dev/docs/latest/)
- [Talos OS GitHub Repository](https://github.com/siderolabs/talos)
- [Talos OS Community Slack](https://slack.dev.talos-systems.io/)
