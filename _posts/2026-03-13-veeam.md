...
| List repositories | `Get-VBRBackupRepository` | `N/A` | `N/A` | `N/A` |
...
| Restore VM / volume | `Start-VBRRestoreVM` | `Veeam.EndPoint.Manager.exe /restore:volume` | `veeamconfig restore volume` | `veeamconfig restore volume` |
| Replication / failover | `Start-VBRFailover` | `N/A` | `N/A` | `N/A` |
| Quick backup | `Start-VBRQuickBackup` | `N/A` | `N/A` | `N/A` |
| API / REST | `Invoke-RestMethod` | `N/A` | `curl` | `curl` |
