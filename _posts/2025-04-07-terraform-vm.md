---
author: muju
title: "Terraform + Cloud-Init VM Deploy"
...
# Install libguestfs-tools for customizing the image
...
# Configure Cloud-Init drive and serial console
...
## Step 4: Terraform Config (main.tf)
